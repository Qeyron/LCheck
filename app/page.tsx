...
export default function Home() {
  ...
  const handleCheck = async () => {
    ...
    try {
      ...
      if (eligibleCount > 0) message += ` Eligible: ${eligibleCount}.`;
      ...
      <main className="container mx-auto px-4 py-12 max-w-7xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200 text-sm font-medium mb-6">
            <span className="w-2 h-2 bg-blue-500 rounded-full mr-2 animate-pulse" aria-hidden="true" />
            {USE_MOCK_RESULTS
              ? 'Demo mode'
              : 'Official Linea Airdrop Check >>> https://linea.build/hub/airdrop'}
          </div>
